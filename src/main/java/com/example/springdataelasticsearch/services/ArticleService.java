...
public class ArticleService {
    ...
    public boolean insertDataInIndex() {
        ...
        article1.setPublishedDate(new Date(1238524200000L));
        ...
        article4.setPublishedDate(new Date(1278613800000L));
        ...
        article6.setPublishedDate(new Date(1014921000000L));
    ...
    public Page<Article> findByAuthorsAge(int age) {
        return articleRepository.findByAuthorsAge(age, PageRequest.of(0, 10));
    }

    public Page<Article> findByAuthorsAgeInRange(int minAge, int maxAge) {
