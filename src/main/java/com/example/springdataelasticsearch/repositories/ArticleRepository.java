...
public interface ArticleRepository extends ElasticsearchRepository<Article, String> {
    ...
    Page<Article> findById(int id, Pageable pageable);
    ...
    Page<Article> findByAuthorsId(int id, Pageable pageable);

    Page<Article> findByAuthorsName(String name, Pageable pageable);

    Page<Article> findByAuthorsAge(int age, Pageable pageable);

//    Page<Article> findByPublishedDate(Date date, Pageable pageable);
